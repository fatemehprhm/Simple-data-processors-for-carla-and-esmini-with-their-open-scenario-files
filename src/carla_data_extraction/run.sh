...
python3 ../data_extractor.py --filename '~/carla/short_brake_carla' &

# Wait for the scenario runner to start
sleep 5

# Run the main scenario
python3 scenario_runner.py --openscenario srunner/My_examples/deceleration1.xosc --reloadWorld --sync